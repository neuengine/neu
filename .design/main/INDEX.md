...
| [l2-window-system-go.md](specifications/l2-window-system-go.md) | Go impl: Window component as ECS entity, diff-driven sync via change-detection, deferred create/destroy commands, main-thread WindowBackend, headless CI backend, RawWindowHandle→render surface (Implements: l1-window-system) | Draft | go | 0.1.0 |
...
| [l2-error-core-go.md](specifications/l2-error-core-go.md) | Go impl: EngineError over stdlib errors, Severity/Audience total-switch enums, range-partitioned Code registry, fs.FS locale catalog with default fallback, build-tag debug traces, Fatal+Developer-only panic (Implements: l1-error-core) | Draft | go | 0.1.0 |
