...
**Based on:** .design/main/PLAN.md v1.5.0
...
**Status:** Active
**Mode:** Phase 1 specs → `Stable` (Bootstrap deactivated for P1). Phase 2+ remain `[Bootstrap]` — `examples/ecs/framework/` gate pending.
