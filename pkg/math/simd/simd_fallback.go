...
// Neu math hot path. This file is the scalar fallback compiled on all non-amd64
// architectures. The API is identical to simd_amd64.go so callers are portable
// without any conditional compilation in their own code.
//
